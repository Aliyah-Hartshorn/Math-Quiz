...
3. [Program Entry Point and Main Loop](#3-program-entry-point-and-main-loop)
4. [The Quiz Loop and Grading Logic](#4-the-quiz-loop-and-grading-logic-run_quiz)
5. [Difficulty Scaling and Topic Selection](#5-difficulty-scaling-and-topic-selection-generate_question)
6. [Category Construction](#6-category-construction-build_categories)
7. [Topic-by-Topic Generator Logic](#7-topic-by-topic-generator-logic)
8. [Output Formatting and Input Parsing Helpers](#8-output-formatting-and-input-parsing-helpers)
...
- Go to [python.org/downloads](https://www.python.org/downloads/) in your browser.
